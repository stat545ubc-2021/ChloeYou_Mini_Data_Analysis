...
1. Which publisher/developer produces the most games and receives the most positive reviews?
...
2. Do some publishers get more positive reviews? Which ones?
...
3. What's the difference between genres in terms of the average and total volume of reviews and average proportion of positive reviews of each genre. 
...
#### Research Question 2
Do some publishers get more positive reviews? Which ones?
##### Summarizing 
...
The subsetted data is indeed tidy since it meets the following critera:
1. Each variable has its own column.
2. Each observation(game) has its own row.
